...
Overlaying these cycles is the **[circadian rhythm](/blog/circadian-rhythms)**--the master clock in the suprachiasmatic nucleus. Light is its strongest cue. Special retinal cells tuned to **blue light (~480 nm)** suppress melatonin and shift the clock later. Morning light anchors the system. This is why a dawn walk stabilizes sleep better than an afternoon one, and why phones in bed are so disruptive.
