...
<div className="not-prose relative mb-8 aspect-[16/9] w-full overflow-hidden rounded-2xl">
  <Image
    src="/images/alcohol-sleep-hero.png"
    alt="Glass of wine and sleep cycle chart at night"
    fill
